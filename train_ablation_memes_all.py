...
from core.emitters.memes_all_emitter import MEMESAllEmitter
from core.emitters.memes_emitter import MEMESConfig
from core.memes_all import MEMESAll
...
@hydra.main(config_path="configs", config_name="ablation_memes_all")
def train(config: ExperimentConfig) -> None:
    ...
    map_elites = MEMESAll(
        ...
        center_scoring_function=me_scoring_fn,
        emitter=es_emitter,
    ...
    repertoire, gradient_repertoire, emitter_state, random_key = map_elites.init(
    ...
    # Main QD loop
    update_fn = partial(map_elites.update)
    full_metrics, full_reeval_metrics, timings, random_key = main_loop(
        ...
        second_repertoire=gradient_repertoire,
