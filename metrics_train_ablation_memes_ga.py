...
from core.emitters_metrics.metrics_memes_emitter import MEMESConfig
from core.emitters_metrics.metrics_memes_ga_emitter import MEMESGAEmitter
...
@hydra.main(config_path="configs", config_name="ablation_memes_ga")
